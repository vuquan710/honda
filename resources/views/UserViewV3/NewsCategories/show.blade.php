        ...
        <section class="blog-top">
            @foreach($listNews as $key => $news)
                ...
                <article class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="grid_3">
                        <h3><a href="{{route('user.v3.news.show', $news['slug'])}}">{{$news['title']}}</a></h3>
                        <a href="{{route('user.v3.news.show', $news['slug'])}}"><img src="{{asset($news['small_image'])}}"
                                                                                   width="100%"
                        ...
                        <div class="button">
                            <a href="{{route('user.v3.news.show', $news['id'])}}">{{__('userV3Messages.xem_them')}}</a>
                        </div>
                    </div>
                </article>
                @if($key%2==1)
