                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="table table-responsive">
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <tbody>
                                @foreach($listVendors as $key => $productvendor)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="action-buttons">
                                                <a href="{{route('admin.vendors.edit', $productvendor['id'])}}" class="info" >
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                <a href="javascript:void(0)" class="red" onclick="confirmDeleteVendorData(this,'{{__('messages.MessageConfirmDeleteVendor')}}')"
                                                   data-url="{{route('admin.vendors.destroy', $productvendor['id'])}}"
