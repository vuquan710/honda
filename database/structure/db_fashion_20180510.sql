...
CREATE TABLE `news` (
  ...
  `en_short_description` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `en_content` mediumtext COLLATE utf8_unicode_ci NOT NULL,
