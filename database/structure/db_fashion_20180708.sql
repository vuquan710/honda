...
MySQL - 10.1.32-MariaDB : Database - fashion
*********************************************************************
*/
...
CREATE TABLE `news` (
  ...
  `en_short_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_content` mediumtext COLLATE utf8_unicode_ci,
  `en_meta_keywords` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_meta_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_meta_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `news_categories` (
  ...
  `en_meta_keywords` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_meta_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_show` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1: Yes/2: No',
  `is_show_on_menu` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1: Yes/2: No : Hiển thị trên top menu, nếu không sẽ được gom vào trong danh mục News',
  `slug` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `p_products` (
  ...
  `image_main_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `short_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` mediumblob,
  `en_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_short_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `en_description` mediumblob,
  `slug` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `using_for_admin` tinyint(3) NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `created_by` bigint(11) DEFAULT NULL,
